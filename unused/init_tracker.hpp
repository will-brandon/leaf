...
/// 
/// @brief      Header for a class that produces an object with functionality to track whether
///             something was initialized. This functionality is typically used in a composition
///             design pattern, i.e. classes will contain an Initiable object to track whether they
