...
///             manager. The class creates a singleton object, i.e. only one window manager object
///             can be created.
///
...
namespace leaf
{
    ...
    class sdl : public window_manager
    {
        ...
        public:
            /// 
            /// @brief  One single instance of the SDL window manager will be created. This
            ///         instance should be used externally to make all API calls.
            /// 
            static sdl instance;
