...
///             graphical user interface window that is managed by multiple threads. This results in
///             a need for correspondence between threads, often a window driver thread and a
///             graphics thread. This interaction occurs in the form of polling events that need
///             updating and using flags to indicate necessary actions such as closing. A window is
