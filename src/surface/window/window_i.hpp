...
namespace leaf
{
    ...
    class window_i : public user_mutable_surface_i
    {
         ...
         * 
         * @throw   exception if an error occurs closing the window (or indicating that a close must
         *          occur)
         */
         ...
         * 
         * @throw   exception if an error occurs determining whether the window will automatically
