...
#ifndef RELEASE_TYPES_H_HEADER_GUARD
#define RELEASE_TYPES_H_HEADER_GUARD
...
namespace utl
{
    ...
    typedef struct release_version : public displayable
    {
        ...
        /**
         * @brief   Construct a new release version object given major, minor, and patch components.
         * 
