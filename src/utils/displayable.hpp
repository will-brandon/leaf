 ...
 * @date    May 6, 2023
 * 
 * @brief   Header for functionality and types to support displaying objects. Provides an abstract
 *          structure that represents a displayable structure. It is displayable in the sense that
