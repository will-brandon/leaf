...
namespace utl
{
    ...
    typedef struct uuid : public displayable
    {
        ...
        ///             hyphens. It will be in the form xxxxxxxx-xxxx-Mxxx-Nxxx-xxxxxxxxxxxx. M and
        ///             N hold special values according to the constraints of RFC 4122. M must be
        ///             the digit '4', N can be either '8', '9', 'A', or 'B'.
        /// 
